...
use crate::util::{hex_deserialize_224, hex_deserialize_256, hex_serialize, is_default};
    ...
    VendorUsage: FactorySettingsVendorUsage,
{
    ...
    #[serde(skip_serializing_if = "is_default")]
    #[serde(serialize_with = "hex_serialize")]
    #[serde(deserialize_with = "hex_deserialize_224")]
...
/// firmware generation commands. Serializes `FactorySettings` with a `[factory]` header.
pub struct WrappedFactorySettings<CustomerData = RawCustomerData, VendorUsage = RawVendorUsage>
where
    CustomerData: FactorySettingsCustomerData,
    VendorUsage: FactorySettingsVendorUsage,
{
    pub factory: FactorySettings<CustomerData, VendorUsage>,
}
...
where
    ...
    VendorUsage: CustomerSettingsVendorUsage,
{
    pub customer: CustomerSettings<CustomerData, VendorUsage>,
}
